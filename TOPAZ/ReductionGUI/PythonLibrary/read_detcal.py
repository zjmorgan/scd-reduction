class ReadDetCal:
    ...
    def read_detcal(self, input, output, first_line):
        """
        ...
        # output is the new integrate file, which is already open
        ...
        while True:
            ...
            # write detector calibration lines to the integrate file
