...
raw_inputFile = eval(input('File name of input hkl file: '))
...
inputFile = eval(input('File name of input fcf file: '))
hkl_input = open(inputFile, 'r')

# Read the name of the output hkl file
outputFile = eval(input('File name of output hkl file: '))
outputFile.rstrip()
...
while True:
    ...
    fabs = abs(fsq_obs-fsq_calc)/sigfsq
